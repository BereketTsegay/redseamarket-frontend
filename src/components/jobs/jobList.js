    ...
    componentWillMount = () => {
        ...
        let salaryTo = ((new URLSearchParams(this.props.location.search).get('salaryTo'))!='')?(new URLSearchParams(this.props.location.search).get('salaryTo')):'';
         ...
         //  console.log(key);
            ...
            axios({
                url: `${BASE_URL}/customer/get/job/list`,
                method: 'POST',
                data:{
                    search_key: key,
                    category: category,
        ...
        return (
            <div id="page" class="site-page">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="section-title text-white text-center">The {localStorage.getItem('country_name')?localStorage.getItem('country_name'):'UAE'}’s Job Finding made easy with Red Sea Market</h2>
                        </div>
                    </div>
                </div>
                </section>
