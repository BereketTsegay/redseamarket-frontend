      ...
      axios.post('http://jama-al-backend.freshpureuae.com/api/customer/get/category',
      {
        ...
        if(result.data.status=="success" && result.status){
            //  this.setState({loginStatus:result.data.data.loged_user_status}); 
             this.setState({categoryArray:result.data.categories});
                     ...
                     <div className="col-xl-8 col-lg-10 mx-auto">
                        ...
                        {(categoryArray && categoryArray.map((categoryArray,indexi) => 
                           <div className="col-md-4 col-6">
                              <a onClick={e => this.onClickHandler((categoryArray['id'])?categoryArray['id']:'')} href="javascript:void(0)" className="category-block-panel text-center d-flex align-items-center" style={{fill:"currentColor"}} >
                                 <div className="w-100">
